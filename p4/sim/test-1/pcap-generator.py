...
with scapy.utils.PcapWriter('packets_in.pcap') as w:
    ...
    p = Ether(dst="00:aa:bb:cc:dd:ee", src="00:11:22:33:44:55")/IPv6(dst="fd9f:53b7:a261:48ed::1", src="fe80::10")/ICMPv6EchoRequest(data="abcdef")
    w.write(p)

    p = Ether(dst=ETHER_BROADCAST, src="00:ab:cd:ef:01:02") / ARP(op=1, psrc="10.1.2.10", pdst="10.1.2.4")
    w.write(p)

    p = Ether(dst="33:33:ff:00:00:01", src="00:11:22:33:44:55") / IPv6(dst="ff02::1:ff00:0001", src="fe80::10")/ICMPv6ND_NS(tgt="fd9f:53b7:a261:48ed::1") / ICMPv6NDOptSrcLLAddr(lladdr='00:11:22:33:44:55')
    w.write(p)
